...
/**
 *  Random
 *  to generate pseudorandom numbers between 0 (inclusive) and the value
 * given (exclusive)
 * 
 * @author pkew20 / 57116
 * @version 1.0
...
public class Random {
	...
	/**
	 *  Random
	 *  to construct objects of type Random
	...
	/**
	 *  randomInt
	 *  to get the next int in the sequence given by the seed
